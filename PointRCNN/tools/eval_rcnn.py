...
def eval_one_epoch(model, dataloader, epoch_id, result_dir, logger):
    # cfg.RPN.ENABLED: True, RCNN.ENABLED: True
...
if __name__ == "__main__":
    ...
    cfg.TAG = os.path.splitext(os.path.basename(args.cfg_file))[0] # like: nuscene_mini
    ...
    # args.DATA_PATH = os.path.join('../../', 'data')
    # data folder should contain KITTI/... sub folders

    with torch.no_grad():
        if args.eval_all: # False by default
